                ...
                <div class="myform form ">
                    <div class="logo mb-3">
                        <div class="col-md-12 text-center">
                            ...
                            <p class="rounded" style="background-color:#00ced1">Enter email to receive OTP. You will receive the OTP only if you are a registered user on our website.</p>
                        </div>
                    </div>
                    ${message}
                <form action="forgotpassword?redo=${param.redo}" method="post">
